...
from mstu_trading.backtest.engine import CombinedStrategy, download_market_data, collect_backtest_metrics
from mstu_trading.market_data.store import latest_data_path
...
def main():
    ...
    output_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "optimization_results.json")
