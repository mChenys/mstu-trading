...
import json
import config
from fee_model import max_affordable_shares
from feishu_gateway import send_text_message
from fetcher import get_mstu_quote, format_price_info, get_session_type
...
def scan():
    ...
    if signal.get("action") == "BUY" and CONFIRMATION_ENABLED:
        ...
        try:
            from trade_confirmation import attach_trade_message_context
